...
public:
	...
	TString(TString& Sobject) ; //Copy Constructor
        ~TString(); //Destructor
        ...
        void assign(TString& SObject);
        void assign(const char *pText);

        //append(string SObject);
        void append(TString& SObject);

	//equals(string SObject);
        bool equals(TString& SObject);

	//equalsIgnoreCase(string SObject);
	bool equalsIgnoreCase(TString& SObject);

	//indexOf(char CSearch);
	int indexOf(char CSearch);
